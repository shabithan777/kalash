...
# второе слово - буквы с 10 по 13 (индексы 9, 10, 11, 12)
word2 = secret_message[1][9:13]

# третье слово - буквы с 6 по 15 через одну (индексы 5, 7, 9, 11, 13)
word3 = secret_message[2][5:15:2]

# четвертое слово - буквы с 8 по 13 в обратном порядке (индексы 7,8,9,10,11,12)
word4 = secret_message[3][7:13][::-1]

# пятое слово - буквы с 17 по 21 в обратном порядке (индексы 16,17,18,19,20)
